...
^ We can then print this list and inspect for patterns to help determine what additional pieces would allow themclassifier to make the right decision, or alternatively which pieces are tricking the classifier into making the wrong decisions.
